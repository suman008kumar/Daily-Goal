          ...
          <div className="camera-stage">
            ...
            {stream && isLive && showOverlay && (
              <>
                ...
                {cloudAI?.configured && (
                  <div className="camera-cloud-ai-chip" title={cloudAI?.result?.model || "Cloud vision AI"}>
                    <span className="camera-cloud-ai-dot" />
                    <span>{cloudAI?.isAnalyzing ? "AI Vision analyzing" : cloudAI?.provider || "Cloud AI"}</span>
                  </div>
                )}

                {cloudAI?.result?.text && (
                  <div className="camera-ai-message" role="status">
                    <Sparkles size={13} />
                    <span>{cloudAI.result.text}</span>
                  </div>
                )}
